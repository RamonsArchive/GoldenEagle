...
const ViewAllPhotos = ({
  ...
  const ViewAllPhotosPortal = () => {
    ...
    return createPortal(
      <main className="fixed inset-0 min-h-screen w-full h-[100dvh] bg-slate-900/90 backdrop-blur-sm z-[100] scrollbar-hide overflow-y-auto">
        {/* <LazyImage
        ...
        /> */}
        <div className="relative flex flex-col xs:hidden w-full h-full overflow-y-auto">
          <div className="flex flex-col xs:hidden w-full h-full overflow-y-auto">
            <div className="flex flex-row justify-end p-5 ">
              <ToggleClose closeFunction={() => setIsVisible(false)} />
            </div>
            <div className="flex-1 overflow-y-auto scrollbar-hide px-5 pb-5 min-h-0 z-[110]">
              <div className="flex w-full h-full flex-col gap-5 min-h-0 overflow-y-auto">
